...
CALL altaTipoSuscripcion(@idSuscripcionCuatrimestrall,4,20,’Cuatrimestral’);
CALL altaTipoSuscripcion(@idSuscripcionBimestral,2,12,’Bimestral);



-- Tabla Suscripcion_Usuario
INSERT INTO TipoSuscripcion (idUsuario,idSuscripcion,tipoSuscripcion,FechaInicio)
 VALUES
